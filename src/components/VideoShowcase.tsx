...
export const VideoShowcase = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute bottom-0 inset-x-0 z-10 flex items-center justify-between gap-3 p-4 md:p-6 transition-smooth opacity-100 md:${
          showControls || !playing ? "opacity-100" : "opacity-60"
        }`}
      >
